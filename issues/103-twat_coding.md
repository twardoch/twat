# twat_coding Implementation Plan
...
**Goal:** Keep pystubnik-focused package healthy while aligning packaging, exports, docs, and host plugin behavior.

**Architecture:** Preserve the standard twat plugin contract: PyPI package `twat-coding`, import module `twat_coding`, entry point `coding = twat_coding`, public `main()`, explicit `__all__`, README examples, and tests. Keep provider/API integrations behind thin clients and keep user-facing domain functions small.
...
- Path: `plugins/repos/twat_coding`.
- Entry point name: `coding`.
- Tier: `complex`.
...
- Modify if needed: `plugins/repos/twat_coding/pyproject.toml`
- Modify if needed: `plugins/repos/twat_coding/src/twat_coding/__init__.py`
- Modify if needed: `plugins/repos/twat_coding/README.md`
- Modify/Create if needed: `plugins/repos/twat_coding/tests/`
